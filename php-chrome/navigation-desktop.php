    ...
    <div class="header">
      ...
      <div class="header__navigation">
        <div class="navigation">
          <a class="navigation__item js-pjax-container <?php if ($navSelectedGallery) { echo'navigation__item--active';} ?>" activeClass="navigation__item--active" href="index.php?pageID=gallery">
            <span class="navigation__item-text">TLDR</span>
            <span class="navigation__item-line"></span>
          </a>
          <span class="navigation__space"></span>
          <a class="navigation__item js-pjax-container <?php if ($navSelectedProjects) { echo'navigation__item--active';} ?>" activeClass="navigation__item--active" href="index.php?pageID=projects">
            <span class="navigation__item-text">Projects</span>
            <span class="navigation__item-line"></span>
          </a>
          <span class="navigation__space"></span>
          <a class="navigation__item js-pjax-container <?php if ($navSelectedAbout) { echo'navigation__item--active';} ?>" activeClass="navigation__item--active" href="index.php?pageID=about">
