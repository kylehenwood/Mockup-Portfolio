  ...
  <div class="mobile-tray__navigation">
    <ul class="mobile-navigation">
      <li class="mobile-navigation__item anim--in-bot anim--delay-40">
        <a class="mobile-navitem js-pjax-link <?php if ($navSelectedGallery) { echo'mobile-navitem--active';} ?>" activeClass="mobile-navitem--active" href="index.php?pageID=gallery">
      ...
      <li class="mobile-navigation__item anim--in-bot anim--delay-120">
        <a class="mobile-navitem js-pjax-link <?php if ($navSelectedAbout) { echo'mobile-navitem--active';} ?>" activeClass="mobile-navitem--active" href="index.php?pageID=about">
          <span class="mobile-navitem__icon"><span class="flat-icon icon--16 icon--arrow-right"></span></span>
    ...
    <div class="mobile-contact">
      ...
      <a class="mobile-contact__link anim--in-bot anim--delay-240 js-pjax-link <?php if ($navSelectedContact) { echo'mobile-contact__link--active';} ?>" activeClass="mobile-contact__link--active" href="index.php?pageID=contact">
        Contact me
      </a>
    </div>
  </div>
